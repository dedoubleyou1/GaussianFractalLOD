    ...
    def add_level(
        ...
        with torch.no_grad():
            ...
            if n_split > 0:
                ...
                split_children, child_idx = subdivide_variable(split_parents, split_cuts, opacity_floor=opacity_floor, opacity_formula=opacity_formula)
